...
///      resolver, not here.
/// @dev PR-scoped pinned snapshot: the upgrade layout diff compares the new `LabelStore`
///      implementation against @custom:contract LabelStoreOld, which implements this interface.
///      Removed before merge with the paired upgrade script and fork test per CONTRIBUTING.md.
/// @custom:security-contact admin@parity.io
interface ILabelStoreOld is IDotnsStore {

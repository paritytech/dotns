...
import {ILabelStoreOld} from "./ILabelStoreOld.sol";
...
///      implementation against this contract. Removed before merge with the paired upgrade
///      script and fork test per CONTRIBUTING.md.
/// @custom:security-contact admin@parity.io
contract LabelStoreOld is Initializable, ILabelStoreOld {

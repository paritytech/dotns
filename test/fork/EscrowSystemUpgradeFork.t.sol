...
contract EscrowSystemUpgradeForkTest is Test {
    ...
    function setUp() public {
        ...
        popRules = IPopRules(registry.get(registry.POP_RULES()));
    ...
    function test_versions_bumped() public view {
        ...
        IDotnsRegistry forwardRegistry = IDotnsRegistry(registry.get(registry.REGISTRY()));
        assertEq(
    ...
    function test_name_escrow_wired_in_registry() public view {
        assertEq(registry.get(registry.NAME_ESCROW()), address(escrow));
    }

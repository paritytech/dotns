...
whether transactions are built against the intended chain/account/network; whether deployment scripts
default to testnet/devnet; whether storage assumptions are appropriate; whether examples rely on
internal/test/unstable endpoints; whether dependencies are pinned and reviewed; whether contract code
has been manually reviewed and tested before deployment; and whether deployment configuration, CORS,
admin/owner roles, upgrade authority, logging, and telemetry suit the intended environment.
